...
import { ArrowRight, Check, Flame, Droplets, ThermometerSun, Phone, Search, TrendingUp } from "lucide-react";
...
const features = [
  ...
  { icon: Search, title: "Lokales SEO für SHK", desc: 'Wir optimieren deine Website für lokale Suchanfragen wie "Heizungsbauer [Stadt]" oder "Sanitär Notdienst in der Nähe".' },
