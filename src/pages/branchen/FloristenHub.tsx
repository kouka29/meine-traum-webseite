...
const config = branche({
  ...
  heroSub: "Kunden suchen 'Florist [Stadt]' für Hochzeit, Trauer oder spontane Geste. Wir bauen die Website, die online verkauft und lokal liefert.",
  ...
  painPoints: [
    ...
    { icon: "🔍", title: "Bei Google unsichtbar", description: "'Blumen Lieferung [Stadt]' — wer da nicht oben steht, verliert spontane Käufe komplett." },
