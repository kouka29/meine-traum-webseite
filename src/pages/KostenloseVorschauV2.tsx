...
const faqs = [
  {
    ...
    a: "Ja – und zwar schneller als Sie denken. Ein einziger neuer Auftrag reicht. Den Rest verdienen Sie. Handwerker die wir betreuen berichten von durchschnittlich 6–12 neuen Anfragen pro Monat allein über ihre neue Website.",
  },
  {
            ...
            <div className="animate-in fade-in slide-in-from-top-2 duration-300 space-y-4">
              ...
              >
                <p className="text-emerald-800 leading-relaxed">
                  💡 Gut! Wusstest Sie dass man auch eine bestehende Website noch
                  deutlich mehr Kunden bringen kann?
                  <br />
                  Wir zeigen Ihnen kostenlos was möglich ist.
                </p>
              </div>
              <Button
                type="button"
      ...
      {state.step === 5 && (
        <form onSubmit={handleSubmit} className="space-y-5">
          <h3 className="text-xl sm:text-2xl font-bold">
            Fast geschafft! Wie kann ich Sie erreichen?
          </h3>
        ...
        <div className="container relative mx-auto px-4 py-12 sm:py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Ich zeige Ihnen in 48 Stunden, wie Ihr Betrieb online wirkt – speziell für Handwerksbetriebe. Kostenlos. Unverbindlich. Ohne Risiko.
            </p>
            ...
            <div className="mt-6 inline-flex items-center gap-3 rounded-full bg-card border border-border px-4 py-2 text-sm font-medium shadow-sm">
              ...
              <span>
                <strong className="text-foreground">⭐ Bereits über 130 Betriebe</strong>{" "}
