  ...
  <main className="pt-20">
    <section className="section-padding">
      <div className="container-narrow px-4">
        <AnimatedSection>
          <div className="text-center mb-20 max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg">
              Sie möchten eine moderne Website für Ihr Unternehmen erstellen lassen? Wir gestalten conversion-optimierte
        ...
        <AnimatedSection>
          <h2 className="text-center mb-5 text-balance">Was Sie bekommen, wenn Sie Ihre Website bei uns erstellen lassen</h2>
