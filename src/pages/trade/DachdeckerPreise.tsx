...
const config: TradeConfig = {
  subline: "Professionell online als Dachdecker – ohne großes Investment.",
  ankerLine2: "Deine neue Dachdecker-Website kostet dich ab 59 €/Monat.",
  starterFeatures: [
    "1 Seite: Leistungen, Referenzen, Kontakt & Anfrageformular",
  ...
  proFeatures: [
    ...
    "Bis zu 5 Seiten – Leistungen, Referenzen, Projekte, Kontakt",
    "Google Maps & Google Business vollständig eingerichtet",
    "Bei Google gefunden werden – wenn Kunden einen Dachdecker suchen",
    "Fertig in ca. 2 Wochen – sorgfältig umgesetzt",
  ],
  premiumFeatures: [
    "Alles aus Pro inklusive – plus:",
    "Bis zu 10 Seiten – deine komplette Online-Präsenz als Dachdecker",
    "Google-Optimierung beim Launch – damit dich Kunden in deiner Stadt finden",
    "Smarte Extras möglich – Kostenrechner, Schadensmeldung oder Buchungstool",
...
const DachdeckerPreise = () => <TradePreiseTemplate config={config} />;
