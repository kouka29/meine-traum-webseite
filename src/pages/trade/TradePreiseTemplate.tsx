...
const buildRentPackages = (cfg: TradeConfig): Pkg[] => [
  {
    name: "Einzelkämpfer",
    price: "59 €/Monat",
    ...
    growth: {
      ...
      items: ["1 Änderung pro Monat inklusive", "Updates & Wartung", "Support per WhatsApp"],
    },
  },
  {
    ...
    desc: "Mindestlaufzeit: 12 Monate, danach monatlich kündbar",
    features: cfg.proFeatures,
    popular: true,
    cta: "Website jetzt sichern",
    growth: {
      price: "+49 €/Monat zubuchbar",
      items: ["Bis zu 3 Änderungen pro Monat inklusive", "Updates & Wartung", "Priority Support per WhatsApp"],
    },
  },
  {
    name: "Marktführer",
...
const buildBuyPackages = (cfg: TradeConfig): BuyPkg[] => [
  {
    name: "Einzelkämpfer",
    price: "990 € einmalig",
    ...
    features: [...cfg.starterFeatures, "Website gehört Ihnen – kein Vertrag"],
    growth: {
      price: "+29 €/Monat zubuchbar",
      items: ["1 Änderung pro Monat inklusive", "Updates & Wartung", "Support per WhatsApp"],
    },
  ...
  },
  {
    ...
    features: [...cfg.proFeatures, "Website gehört Ihnen – kein Vertrag"],
    growth: {
      price: "+49 €/Monat zubuchbar",
      items: ["Bis zu 3 Änderungen pro Monat inklusive", "Updates & Wartung", "Priority Support per WhatsApp"],
    },
  ...
  },
  {
    ...
    features: [...cfg.premiumFeatures, "Website gehört Ihnen – kein Vertrag"],
    growth: {
      price: "+79 €/Monat zubuchbar",
      items: [
        "Bis zu 5 Änderungen pro Monat inklusive",
...
const buildFaqs = (cfg: TradeConfig) => [
  {
    ...
    >
      ...
      <div className="space-y-2">
        <Button
          ...
          className="w-full"
          onClick={() =>
            pkg.priceId && onCheckout ? onCheckout(pkg) : onOpen(pkg.badge ?? pkg.name)
          }
...
const BuyCard = ({
  ...
  <AnimatedSection delay={i * 0.08}>
    ...
    >
      ...
      <p className="font-heading text-3xl font-bold gradient-text mb-1">{pkg.price}</p>
      <p className="text-xs text-muted-foreground mb-3">zzgl. 19 % MwSt.</p>
      {pkg.compare && <p className="text-xs text-muted-foreground mb-5">{pkg.compare}</p>}
...
const TradePreiseTemplate = ({ config }: { config: TradeConfig }) => {
  const rentPackages = buildRentPackages(config);
  const buyPackages = buildBuyPackages(config);
  ...
  return (
    <main className="pt-20">
      ...
      >
        <span className="text-foreground/80">🎁 Noch keine Demo gesehen? Starte kostenlos — </span>
        <button
          type="button"
          ...
          <AnimatedSection>
            <div className="text-center mb-12 max-w-3xl mx-auto">
              ...
              <h1 className="mb-5 text-balance">
                Ein Auftrag reicht. <span className="gradient-text">Den Rest verdienst du.</span>
              </h1>
              <p className="text-muted-foreground text-lg mb-5">{config.subline}</p>
          ...
          <Tabs defaultValue="miete" className="mb-12">
            ...
            <TabsContent value="miete">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {rentPackages.filter((p) => !p.enterprise).map((pkg, i) => (
                  <PackageCard key={pkg.name} pkg={pkg} i={i} onOpen={openPopup} onCheckout={openCheckout} />
                ))}
              </div>
              <div className="flex justify-center my-8">
                <Button
                  ...
                  data-pricing-cta="true"
                  className="h-auto min-h-12 max-w-full whitespace-normal text-center py-3 px-6 bg-transparent border-2 border-primary text-primary hover:bg-primary/10 hover:text-primary"
                >
                  ...
                  <div className="rounded-2xl p-8 md:p-10 border border-foreground/40 bg-gradient-to-br from-card to-background flex flex-col md:flex-row md:items-center gap-8">
                    ...
                    <div className="md:w-auto">
                      <Button
                        variant="gradient"
                        size="lg"
                        onClick={() => openPopup(pkg.badge ?? "Enterprise – Auf Anfrage")}
                        data-pricing-cta="true"
                      >
                        {pkg.cta} <ArrowRight size={16} />
                      </Button>
            ...
            <TabsContent value="kauf">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {buyPackages.map((pkg, i) => (
                  <BuyCard key={pkg.name} pkg={pkg} i={i} onOpen={openPopup} onCheckout={openCheckout} />
                ))}
              </div>
              <div className="flex justify-center my-8">
                <Button
                ...
                <div className="rounded-2xl p-8 md:p-10 border border-foreground/40 bg-gradient-to-br from-card to-background flex flex-col md:flex-row md:items-center gap-8">
                  ...
                  <div className="md:w-auto">
                    <Button
                      variant="outline"
                      size="lg"
                      onClick={() => openPopup(buyEnterprise.badge)}
                      data-pricing-cta="true"
                    >
          ...
          <AnimatedSection>
            <div className="bg-card rounded-2xl p-8 md:p-10 border border-border text-center max-w-3xl mx-auto mb-10">
              ...
              <Button
                ...
                onClick={() => openPopup("Kostenlose Beratung")}
                data-pricing-cta="true"
                className="bg-transparent border-2 border-primary text-primary hover:bg-primary/10 hover:text-primary"
              >
...
export default TradePreiseTemplate;