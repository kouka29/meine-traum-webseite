...
const faqs = [
  ...
  },
  {
    ...
    a: "du kannst du auf die Warteliste setzen lassen und bekommen im nächsten Monat Priorität.",
  },
];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2">
              ...
              <Textarea
                ...
                placeholder="Was sollten wir noch wissen, um die beste Vorschau für du zu bauen? (z. B. Lieblingsfarben, Vorbilder, besondere Leistungen ...)"
                maxLength={1000}
                rows={4}
              />
            </div>
...
const KostenloseVorschau2 = () => {
  ...
  const heroBadge = isWaitlist
    ? `Alle Plätze im ${monatName} vergeben – sichere sich jetzt einen Platz für ${nextMonthLabel}`
