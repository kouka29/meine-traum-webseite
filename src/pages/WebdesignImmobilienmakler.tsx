...
import { ArrowRight, Check, Home, Search, Camera, Smartphone, TrendingUp, MapPin } from "lucide-react";
  ...
  <main id="main-content" className="pt-20">
    <section className="section-padding">
      <div className="container-narrow px-4">
          ...
          <div className="text-center mb-20 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
              <Button variant="gradient" size="lg" className="animate-cta-pulse" asChild>
                <Link to="/kontakt">Kostenlose Website-Vorschau für Makler <ArrowRight size={18} aria-hidden={true} focusable={false} /></Link>
              </Button>
        ...
        <AnimatedSection>
          <h2 className="text-center mb-16 text-balance">So machen wir du zum Makler Nr. 1 in deiner Region</h2>
        </AnimatedSection>
