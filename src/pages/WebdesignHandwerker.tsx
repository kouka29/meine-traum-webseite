...
import { ArrowRight, CheckCircle, Hammer, Search, Smartphone, Star, TrendingUp, Users } from "lucide-react";
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@/components/ui/accordion";

const painPoints = [
  "Sie verlieren Aufträge an modernere Handwerksbetriebe mit besserer Online-Präsenz",
  "Ihre aktuelle Website ist veraltet und macht keinen professionellen Eindruck",
  "Potenzielle Kunden finden Sie bei Google nicht – aber Ihre Konkurrenz schon",
  "Ihre Website sieht auf dem Smartphone schlecht aus, obwohl die meisten dort suchen",
];

const features = [
  { icon: Hammer, title: "Design für Handwerker", desc: "Ihre Website zeigt sofort, wer Sie sind und was Sie können – vertrauenswürdig, professionell und einladend." },
  { icon: Search, title: "Lokales SEO", desc: "Wir sorgen dafür, dass Sie bei Google Maps und lokalen Suchanfragen ganz oben erscheinen." },
  { icon: Star, title: "Bewertungen einbinden", desc: "Zeigen Sie Ihre besten Google-Bewertungen direkt auf der Website – für sofortiges Vertrauen." },
  { icon: Smartphone, title: "Mobilfreundlich", desc: "Perfekte Darstellung auf Smartphone und Tablet – da, wo Ihre Kunden nach Handwerkern suchen." },
  { icon: Users, title: "Einfache Kontaktaufnahme", desc: "Click-to-Call, Kontaktformular und WhatsApp-Button – Kunden erreichen Sie mit einem Klick." },
  { icon: TrendingUp, title: "Messbar mehr Aufträge", desc: "Tracking und Analytics zeigen Ihnen genau, wie viele Anfragen über Ihre Website reinkommen." },
];
...
const faqs = [
  ...
  { q: "Was kostet eine Handwerker-Website?", a: "Unsere Handwerker-Websites starten ab 1.500 €. Dafür erhalten Sie ein professionelles, conversion-optimiertes Design mit SEO-Grundlagen. Eine kostenlose Vorschau gibt es in 48h." },
  ...
  <main className="pt-20">
    <section className="section-padding">
      <div className="container-narrow px-4">
        <AnimatedSection>
          <div className="text-center mb-20 max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg">
              Sie sind Handwerker und Ihre Website bringt keine Anfragen? Wir erstellen professionelle Websites
              speziell für Handwerksbetriebe – damit Sie online gefunden werden und mehr Kunden gewinnen.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
              <Button variant="gradient" size="lg" className="animate-cta-pulse" asChild>
                <Link to="/kontakt">Kostenlose Website-Vorschau für Handwerker <ArrowRight size={18} /></Link>
              </Button>
        ...
        <AnimatedSection>
          <h2 className="text-center mb-16 text-balance">So bringen wir Ihren Handwerksbetrieb online nach vorne</h2>
        </AnimatedSection>
        ...
        <AnimatedSection>
          <div className="mb-20">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-center text-lg mb-10">
              Ob neue Website, Relaunch oder Conversion-Optimierung – wir haben die passende Lösung für Ihren Handwerksbetrieb.
            </p>
