...
const benefits = [
  ...
  { icon: LayoutDashboard, title: "Klar strukturierte Seiten", desc: "Besucher verstehen in unter 5 Sekunden, was du anbieten und warum sie bei dir richtig sind. Keine Verwirrung, kein Absprung." },
