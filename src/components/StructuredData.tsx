...
const faqsByPage: Record<string, FaqItem[]> = {
  ...
  "/webdesign-aerzte": [
    ...
    { q: "Was kostet eine Website für Ärzte?", a: "Unsere Praxis-Websites starten ab 990 €. Du erhältst ein individuelles, DSGVO-konformes Design mit lokaler SEO-Optimierung." },
