...
const faqsByPage: Record<string, FaqItem[]> = {
  "/": [
    { q: "Was kostet eine conversion-optimierte Website?", a: "Unsere Projekte starten ab 990 €. Der genaue Preis hängt vom Umfang ab – aber Sie sehen vorher im kostenlosen Konzept genau, was Sie bekommen. Keine Überraschungen." },
  ...
  "/webdesign-preise": [
    { q: "Was kostet eine Website erstellen lassen?", a: "Unsere Webdesign-Preise starten ab 990 € für eine professionelle Website. Der genaue Preis richtet sich nach Umfang, Funktionalität und individuellen Anforderungen." },
  ...
  "/webdesign-shk": [
    ...
    { q: "Was kostet eine Website für SHK-Betriebe?", a: "Unsere Webdesign-Projekte für SHK-Betriebe starten ab 990 €. Sie erhalten eine kostenlose Vorschau in 48 Stunden." },
  ...
  "/webdesign-handwerker": [
    ...
    { q: "Was kostet eine Handwerker-Website?", a: "Unsere Handwerker-Websites starten ab 990 €. Dafür erhalten Sie ein professionelles, conversion-optimiertes Design mit SEO-Grundlagen." },
  ...
  "/webdesign-aerzte": [
    ...
    { q: "Was kostet eine Website für Ärzte?", a: "Unsere Praxis-Websites starten ab 990 €. Sie erhalten ein individuelles, DSGVO-konformes Design mit lokaler SEO-Optimierung." },
...
const servicesByPage: Record<string, { name: string; description: string; audience?: string }> = {
  ...
  "/website-erstellen-lassen": {
    ...
    description: "Professionelle, conversion-optimierte Website-Erstellung für Unternehmen. Mobilfreundlich, SEO-ready, ab 990 €.",
  },
  "/landingpage-erstellen-lassen": {
  ...
  "/webdesign-preise": {
    ...
    description: "Transparente Webdesign-Preise ab 990 €. Faire Festpreise ohne versteckte Kosten.",
  },
